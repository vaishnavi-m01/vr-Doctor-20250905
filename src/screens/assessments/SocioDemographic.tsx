        ...
        <FormCard icon="👤" title="Section 1: Personal Information">
          ...
          <View className="mt-3">
            ...
            <View className="flex-row gap-2">
              ...
              >
                <Text className={`text-lg mr-1 ${
                  gender === 'Other' ? 'text-white' : 'text-[#2c4a43]'
                }`}>
                  ⚧
                </Text>
                <Text className={`font-medium text-xs ${
          ...
          <View className="mt-3">
            ...
            <View className="flex-row gap-2">
              ...
              >
                <Text className={`text-lg mr-1 ${
                  maritalStatus === 'Widowed' ? 'text-white' : 'text-[#2c4a43]'
                }`}>
                  🕊️
                </Text>
                <Text className={`font-medium text-xs ${
          ...
          <View className="mt-3">
            ...
            <View className="flex-row gap-2">
              ...
              >
                <Text className={`text-lg mr-1 ${
                  faithWellbeing === 'Yes' ? 'text-white' : 'text-[#2c4a43]'
                }`}>
                  ✅
                </Text>
                <Text className={`font-medium text-xs ${
              ...
              >
                <Text className={`text-lg mr-1 ${
                  faithWellbeing === 'No' ? 'text-white' : 'text-[#2c4a43]'
                }`}>
                  ❌
                </Text>
                <Text className={`font-medium text-xs ${
          ...
          <View className="mt-3">
            ...
            <View className="flex-row gap-2">
              ...
              >
                <Text className={`text-lg mr-1 ${
                  practiceReligion === 'Yes' ? 'text-white' : 'text-[#2c4a43]'
                }`}>
                  ✅
                </Text>
                <Text className={`font-medium text-xs ${
              ...
              >
                <Text className={`text-lg mr-1 ${
                  practiceReligion === 'No' ? 'text-white' : 'text-[#2c4a43]'
                }`}>
                  ❌
                </Text>
                <Text className={`font-medium text-xs ${
        ...
        <FormCard icon="🧠" title="Section 3: Lifestyle and Psychological Factors">
          <View className="mt-3">
            ...
            <View className="flex-row gap-2">
              ...
              >
                <Text className={`text-lg mr-1 ${
                  smokingHistory === 'Never' ? 'text-white' : 'text-[#2c4a43]'
                }`}>
                  🚭
                </Text>
                <Text className={`font-medium text-xs ${
              ...
              >
                <Text className={`text-lg mr-1 ${
                  smokingHistory === 'Former Smoker' ? 'text-white' : 'text-[#2c4a43]'
                }`}>
                  🚬
                </Text>
                <Text className={`font-medium text-xs ${
              ...
              >
                <Text className={`text-lg mr-1 ${
                  smokingHistory === 'Current Smoker' ? 'text-white' : 'text-[#2c4a43]'
                }`}>
                  💨
                </Text>
                <Text className={`font-medium text-xs ${
          ...
          <View className="mt-3">
            ...
            <View className="flex-row gap-2">
              ...
              >
                <Text className={`text-lg mr-1 ${
                  alcoholConsumption === 'Never' ? 'text-white' : 'text-[#2c4a43]'
                }`}>
                  🚫
                </Text>
                <Text className={`font-medium text-xs ${
              ...
              >
                <Text className={`text-lg mr-1 ${
                  alcoholConsumption === 'Occasionally' ? 'text-white' : 'text-[#2c4a43]'
                }`}>
                  🍷
                </Text>
                <Text className={`font-medium text-xs ${
              ...
              >
                <Text className={`text-lg mr-1 ${
                  alcoholConsumption === 'Frequently' ? 'text-white' : 'text-[#2c4a43]'
                }`}>
                  🍺
                </Text>
                <Text className={`font-medium text-xs ${
          ...
          <View className="mt-3">
            ...
            <View className="flex-row gap-2">
              ...
              >
                <Text className={`text-lg mr-1 ${
                  physicalActivityLevel === 'Sedentary' ? 'text-white' : 'text-[#2c4a43]'
                }`}>
                  🛋️
                </Text>
                <Text className={`font-medium text-xs ${
              ...
              >
                <Text className={`text-lg mr-1 ${
                  physicalActivityLevel === 'Moderate' ? 'text-white' : 'text-[#2c4a43]'
                }`}>
                  🚶
                </Text>
                <Text className={`font-medium text-xs ${
              ...
              >
                <Text className={`text-lg mr-1 ${
                  physicalActivityLevel === 'Active' ? 'text-white' : 'text-[#2c4a43]'
                }`}>
                  🏃
                </Text>
                <Text className={`font-medium text-xs ${
          ...
          <View className="mt-3">
            ...
            <View className="flex-row gap-2">
              ...
              >
                <Text className={`text-lg mr-1 ${
                  stressLevels === 'Low' ? 'text-white' : 'text-[#2c4a43]'
                }`}>
                  😌
                </Text>
                <Text className={`font-medium text-xs ${
              ...
              >
                <Text className={`text-lg mr-1 ${
                  stressLevels === 'Moderate' ? 'text-white' : 'text-[#2c4a43]'
                }`}>
                  😐
                </Text>
                <Text className={`font-medium text-xs ${
              ...
              >
                <Text className={`text-lg mr-1 ${
                  stressLevels === 'High' ? 'text-white' : 'text-[#2c4a43]'
                }`}>
                  😰
                </Text>
                <Text className={`font-medium text-xs ${
          ...
          <View className="mt-3">
            ...
            <View className="flex-row gap-2">
              ...
              <Pressable 
                ...
                className={`flex-1 flex-row items-center justify-center rounded-full py-3 px-2 ${
                  technologyExperience === 'No experience' 
                    ? 'bg-[#4FC264]' 
                    : 'bg-[#EBF6D6]'
                }`}
              >
                <Text className={`text-lg mr-1 ${
                  technologyExperience === 'No experience' ? 'text-white' : 'text-[#2c4a43]'
                }`}>
                  📱
                </Text>
                <Text className={`font-medium text-xs ${
              ...
              <Pressable 
                ...
                className={`flex-1 flex-row items-center justify-center rounded-full py-3 px-2 ${
                  technologyExperience === 'Some experience' 
                    ? 'bg-[#4FC264]' 
                    : 'bg-[#EBF6D6]'
                }`}
              >
                <Text className={`text-lg mr-1 ${
                  technologyExperience === 'Some experience' ? 'text-white' : 'text-[#2c4a43]'
                }`}>
                  💻
                </Text>
                <Text className={`font-medium text-xs ${
              ...
              <Pressable 
                ...
                className={`flex-1 flex-row items-center justify-center rounded-full py-3 px-2 ${
                  technologyExperience === 'Proficient' 
                    ? 'bg-[#4FC264]' 
                    : 'bg-[#EBF6D6]'
                }`}
              >
                <Text className={`text-lg mr-1 ${
                  technologyExperience === 'Proficient' ? 'text-white' : 'text-[#2c4a43]'
                }`}>
                  🚀
                </Text>
                <Text className={`font-medium text-xs ${
